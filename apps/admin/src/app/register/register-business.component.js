...
import { AuthService, UploadService } from "../../../../../libs/shared/data-access/src/index.ts";
...
let RegisterBusinessComponent = class RegisterBusinessComponent {
    ...
    totalSteps = 3;
    // File upload signals
    logoFile = signal(null);
    cacDocumentFile = signal(null);
    logoUrl = signal(null);
    cacDocumentUrl = signal(null);
...
RegisterBusinessComponent = __decorate([
    Component({
...
export { RegisterBusinessComponent };
//# sourceMappingURL=register-business.component.js.map