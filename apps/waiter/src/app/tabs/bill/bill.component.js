...
import { BillsApiService, TablesApiService } from "../../../../../../libs/shared/data-access/src/index.ts";
let BillComponent = class BillComponent {
    route = inject(ActivatedRoute);
    router = inject(Router);
    billService = inject(BillsApiService);
    ...
    serviceChargeNaira = computed(() => ((this.bill()?.subtotalKobo ?? 0) * (this.bill()?.serviceChargePercent ?? 0)) / 10000);
